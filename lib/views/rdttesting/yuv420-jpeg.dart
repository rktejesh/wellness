...
class Yuv420ToJpeg extends StatefulWidget {
  ...
  @override
  State<Yuv420ToJpeg> createState() => Yuv420ToJpegState();
}

class Yuv420ToJpegState extends State<Yuv420ToJpeg> {
  ...
  cameraStream(CameraImage cameraImage) async {
    ...
    _similarity = await matching?.similarity(tempCameraImage) ?? 0.0;
    if (_similarity > 0.70) {
